        ...
        .map((page) => (
          <div className="beach-page">
            ...
            <div className="beach-page-content">
              <div className="beach-page-time">
                <p className="beach-page-time-text">
                  <span className="accent">Today</span>, {day} {month}{" "}
              ...
              <p className="beach-page-text-report">
                ...
                <span className="pageObject">{page[0].airTemperature.sg}º</span>
                , <span className="pageObject">{page[0].windSpeed.sg} kts</span>{" "}
                wind from the
                ...
                , a swell height of{" "}
                <span className="pageObject">{page[0].swellHeight.sg} m</span>,
                a swell interval of{" "}
                <span className="pageObject">
                  {page[0].swellPeriod.noaa} kts
                </span>
                .
              </p>

              <p className="beach-page-text-report-tide">
                A preia-mar dá-se às <span className="pageObject">12:43</span>,{" "}
                <br /> a baixa-mar às <span className="pageObject">18:43</span>.
              </p>
            </div>
            ...
            <div className="current-conditions-container">
              ...
              <div className="current-conditions">
                ...
                <div>
                  ...
                  <p>{parseFloat(page[0].swellPeriod.noaa).toFixed(1)}s</p>
                </div>
                <div>
                  <img src={swellHeight} alt="" />
                  <p>{parseFloat(page[0].swellHeight.sg).toFixed(1)}m</p>
                </div>
                <div>
                  <img src={wind} alt="" />
                  <p>
                    {parseFloat(page[0].windSpeed.sg).toFixed(1)}
            ...
            <div className="conditions-hour-container">
              <h3>Current conditions</h3>
              <div className="conditions-hour"></div>
            </div>
          </div>
        ))}
    </div>
